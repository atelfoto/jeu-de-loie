...
let questions = [
    ...
    new Question("10. Sous quel nom est né DAN-AR-BRAZ ?", ["Daniel Le Bras", "Alan Stivel", "Pierre Le Gloan"], "Daniel Le Bras"),
    new Question("11. En quelle année est né DAN-AR-BRAZ ?", ["1939", "1957", "1949"], "1957"),
    new Question("12. En quelle année a t’on fêté les 70 ans du bagad de Quimper ?", ["2017", "2019", "2015"], "2019"),
    new Question("13. Combien de jours dure le festival de Cornouaille ?", ["6 jours", "4 jours", "5 jours"], "6 jours"),
    new Question("14. Où se déroulera le festival La vie en Reuz en 2021 ?", ["Concarneau", "Douarnenez", "Quimper"], "Douarnenez"),
    new Question("15. Depuis quelle année le festival \"La vie en reuz\" existe t'il?", ["2010", "2014", "2012"], "2012"),
    new Question("16. Quel est l'instrument principal de la musique bretonne ?", ["Le Biniou", "La Cornemuse", "La Bombarde"], "Le Biniou"),
    new Question("17. Quel métier Philippe Poupon  né à Quimper exerce t-il ?", ["Plongeur", "Navigateur", "Politique"], "Navigateur"),
    new Question("18. Quel  est le surnom de JEAN LE CAM ?", ["Le Roi Jean", "Le Dauphin", "Le Roi Richard"], "Le Roi Jean"),
    new Question("19. Qui sont les Jhonnies ?", ["Des producteurs d’oignons", "Des membres du fan-club breton de Johnny Hallyday", "Des éleveurs de porc de la race John Bent"], "Des producteurs d’oignons"),
    new Question("20. La ville de Locronan est connue pour ses illuminations durant la période de Noel ", ["Vrai", "Faux", null], "Vrai"),
];
class Quiz {
...
const display = {
    ...
    endQuiz: function() {
        ...
        <a class="next" href="./bonus.html">Quiz suivant</a>
