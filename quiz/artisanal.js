...
let questions = [
    new Question("1: Quel artisan a inventé le bol prénom à oreilles ?", ["Alan Stivel", "Henriot", null], "Henriot"),
    ...
    new Question("5. Quel est l’ingrédient principal d’une crêpe dentelle ?", ["Du beurre ", "Du chocolat", null], "Du beurre "),
    new Question("6. A l’aide de quel matériel cuit on une crêpe ?", ["Une biling ", "Un four", null], "Une bilig"),
    new Question("7. La crêpe complète est composée d’un œuf, de jambon et de fromage", ["Vrai", "Faux", null], "Vrai"),
    new Question("8. Quelle est la spécialité de Pascal Jaouen ?", ["La Broderie d'art", "La cuisine", null], "La Broderie d'art"),
    ...
    new Question("14. Quelle est la spécialité de Locronan ?", ["La peinture sur toile", "La verrerie", null], "La varrerie"),
    new Question("15. La ville de Locronan est connue pour ses illuminations durant la période de Noel ", ["Vrai", "Faux", null], "Vrai"),
    new Question("16. Combien de navires ont été construits par l’entreprise Piriou ?", ["250", "500", null], "500"),
    new Question("17. Quel âge a l’entreprise Piriou ?", ["70 ans", "55 ans", null], "55 ans"),
    ...
    new Question("21. Quel âge a Monique Ranou ?", ["-Plus de 200 années", "Plus de 110 années", "Plus de 90 années"], "Plus de 110 années"),
